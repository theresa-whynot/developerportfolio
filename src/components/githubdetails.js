...
const GitHubDetails = ({ repoTitle, repoColor }) => {
    ...
    return (
        ...
        <div>
            <Segment.Group >
                <Segment color={repoColor}>
                    <h5>The below {repoTitle} information was fetched through a GitHub REST API call  <Icon color={repoColor} name='object group' /></h5>
                </Segment>
                <Segment>
                    {readmeContent ? (
                        <div>
