        ...
        <div>
            ...
            <Segment.Group >
                <Segment color="purple">
                    <h5>The below Developer Portfolio information was fetched through a GitHub REST API call  <Icon color="purple" name='object group' /></h5>
                </Segment>
                <Grid columns={2}>
            <Grid.Column>
                                ...
                                <Table.Row>
                                    ...
                                    <Table.HeaderCell colSpan='1'>
                                        ...
                                        <div style={{ marginTop: '10px', marginLeft: '30px' }}>
                                            <Grid columns={2}>
                                                <Grid.Column>
                                                            <a href="https://github.com/theresa-whynot/developerportfolio/tree/main" target="_blank" rel="noopener noreferrer">
                                                        <Button color="blue" >
                                                ...
                                                <Grid.Column>
                                                            <a href="https://github.com/theresa-whynot/developerportfolio/archive/main.zip">
                                                        <Button color="purple">
...
export default DeveloperPortfolioDetails;
